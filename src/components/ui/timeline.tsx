  ...
  return (
    <div className="w-full bg-black dark:bg-neutral-950 font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 text-white dark:text-white max-w-4xl">Milestones from my journey</h2>
        <p className="text-neutral-400 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          From starting as a frontend developer to building full-stack systems and launching my own products — here’s a
          glimpse into how my journey has evolved over the years.
        </p>
      </div>
